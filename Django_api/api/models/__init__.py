...
from .fournisseur import Fournisseur, Ristourne
...
from .collaborateur import Collaborateur  # Importé depuis le nouveau fichier
from .maintenance import Maintenance  # Ne plus importer Collaborateur d'ici
