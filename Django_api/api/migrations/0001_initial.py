    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adresse', models.TextField(blank=True, verbose_name='Adresse')),
                ('role', models.IntegerField(choices=[(1, 'Client'), (2, 'Commercial'), (3, 'Collaborateur'), (4, 'Fournisseur'), (5, 'ChargéStock')], verbose_name='Rôle')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('DateCreation', models.DateTimeField(auto_now_add=True)),
                ('DateMiseAJour', models.DateTimeField(auto_now=True)),
                ('IdMaintenance', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.maintenance', verbose_name='Dernière maintenance')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='IdVehicule',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='maintenances', to='api.vehicule', verbose_name='Véhicule'),
        ),
        migrations.CreateModel(
            name='Livraison',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('IdCommande', models.IntegerField(blank=True, null=True, verbose_name='ID de la commande')),
                ('Quantite', models.PositiveIntegerField(default=1, verbose_name='Quantité')),
                ('IdDevis', models.ForeignKey(blank=True, db_column='IdDevis', null=True, on_delete=django.db.models.deletion.CASCADE, to='api.devis')),
                ('IdProduit', models.ForeignKey(db_column='IdProduit', on_delete=django.db.models.deletion.CASCADE, to='api.product')),
            ],
            options={
