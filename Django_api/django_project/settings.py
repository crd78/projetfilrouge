...
ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', 'localhost,127.0.0.1,192.168.1.111,192.168.1.44').split(',')
...
DATABASES = {
    'default': {
        ...
        'HOST': os.environ.get('DB_HOST', 'db'),  # 'db' pour Docker, '127.0.0.1' pour CI
